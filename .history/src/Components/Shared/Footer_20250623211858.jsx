        ...
        <div className='font-nunito'>
            <footer className="footer sm:footer-horizontal font-nunito bg-gray-100 md:justify-evenly text-center md:text-left justify-center p-10">
                ...
                <nav >
                    ...
                    <p className="link text-base  flex gap-2 items-center "><MdOutlineMail />QuranMazeedBd@gmail.com</p>
                    <p className="link text-base flex gap-2 items-center"><IoLocationOutline /> Dhaka, Bangladesh</p>
