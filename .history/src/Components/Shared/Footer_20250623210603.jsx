        ...
        <div className='font-nunito'>
            <footer className="footer sm:footer-horizontal font-nunito bg-gray-100 md:justify-evenly text-center md:text-left justify-center p-10">
                <nav>
                    ...
                    <p className='max-w-xs text-justify leading-[1.5] text-[16px] text-gray-500'>Quran Mazeed is a clean and easy-to-use website for reading the Qur'an online, by page or surah, with beautiful Arabic script.</p>
                </nav>
                <nav>
