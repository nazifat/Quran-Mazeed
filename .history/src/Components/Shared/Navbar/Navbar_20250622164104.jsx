        ...
        <div className="navbar shadow-sm custom-navbar md:px-10 font-inter">
            <div className="navbar-start ">
                ...
                <Link to="/" className="block w-[100px] bg-green-100 ">
                    <img
                        src="https://www.canva.com/design/DAGrEkzbctg/gAnpwXYawSFxziTLg0jxig/view?utm_content=DAGrEkzbctg&utm_campaign=designshare&utm_medium=link2&utm_source=uniquelinks&utlId=h82828f8085"
