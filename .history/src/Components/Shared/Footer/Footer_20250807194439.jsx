...
const Footer = () => {
    return (
        <div className='font-nunito custom-footer'>
            ...
            <footer className="footer text-center justify-center sm:footer-horizontal bg-gray-200 shaddow-lg items-center p-4">
                <aside className="grid-flow-col items-center">

                    <p>Copyright © {new Date().getFullYear()}  Quran Kareem - All right reserved</p>
                </aside>
