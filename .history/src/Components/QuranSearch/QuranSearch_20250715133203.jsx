        ...
        <div className='py-10'>
            ...
            <div className='flex gap-4 justify-center'>
                <select
                    ...
                    <option disabled={true} value="" className='bg-white dark:bg-gray-600 text-black dark:text-white'> Surah</option>
                    {
                        surahs.map(surah => (
                ...
                <select
                    ...
                    className='bg-white dark:bg-gray-600 text-black dark:text-white select'>
                ...
                <button className='btn btn-ghost bg-pink-300 text-gray-100'
