    ...
    return (
        <div>
            ...
            <div className='flex justify-center  gap-5 md:gap-10 items-center my-5'>
                <Link className='btn md:btn-md btn-xs previous-btn' onClick={handlePrevious} disabled={currentPage === 1}>  Previous page</Link>
                <span className="font-medium text-gray-700 text-sm md:text-base">
                    Page {currentPage} of {totalPages}
                </span>
 
                <Link className='btn md:btn-md btn-xs next-btn' onClick={handleNext} disabled={currentPage === totalPages}>Next Page</Link>
            </div>
        </div>
    );
};
