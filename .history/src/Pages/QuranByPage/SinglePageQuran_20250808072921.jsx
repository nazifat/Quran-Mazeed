            ...
            return (
              <React.Fragment key={ayah.number}>
                {isNewSurah && surahs[currentSurahNum] && (
                  <h2
                    className="py-5 mb-10 bg-pink-200 text-xl md:text-2xl font-bold text-[#4F888B] border text-center md:w-1/2 mx-auto w-1/2 shadow-sm md:w-1/4 w-full mx-auto p-4"
                    dir="ltr"
                  >
                ...
                <span className="inline mt-10 font-taha text-2xl leading-[2]">
                  {ayah.text}
                  <span
