    ...
    return (
        <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
            <div className="max-w-xl w-full bg-white rounded-xl shadow-lg p-8">
                <div className="flex">
                    <h2 className="text-2xl font-bold text-center text-[#15B3B6] mb-4">
                        <GiPalmTree /> Support Quran Reading
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className="w-full border px-4 py-2 bg-white rounded-md focus:outline-none focus:ring focus:border-green-500"
