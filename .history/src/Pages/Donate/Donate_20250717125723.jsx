        ...
        <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
            <div className="max-w-xl w-full bg-white rounded-xl shadow-lg p-8">
                <h2 className="text-2xl font-bold text-center text-green-700 mb-4">
                    Support Quran Learning
                </h2>
                <p className="text-center text-gray-600 mb-6">
                    Your donation helps us keep this platform free and accessible for everyone.
                </p>
                ...
                <p className="text-center mt-4 text-sm text-gray-600">
                   Or You Can Donate via bKash: <strong>01XXXXXXXXX</strong><br />
                    After payment, please <a href="https://forms.gle/your-form" className="underline text-green-600" target="_blank" rel="noreferrer">submit your transaction here</a>.
                </p>
            </div>
        </div>
    );
