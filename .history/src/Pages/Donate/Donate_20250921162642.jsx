...
const Donate = () => {
  ...
  return (
    <div className="py-10 min-h-[500px] min-h-xl bg-gray-50 dark:bg-gray-900 flex items-center justify-center p-4 transition-colors duration-300">
      <div className="max-w-xl w-full bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
        ...
        <p className="text-center text-gray-600 dark:text-gray-300 mb-6">
          Your contribution helps us improve this platform and support the people
          behind it.
        </p>

       
        <p className="text-center mt-4 text-sm text-gray-600 dark:text-gray-300 flex gap-2 items-center justify-center">
          You Can Contribute via bKash: <strong>+8801731797802</strong>
