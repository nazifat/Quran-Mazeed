...
const SearchedPage = () => {
    ...
    const {translationData, ayahs: ayahsEnglish } = useSurahTranslation(suraNumber, 'en.sahih');
    const {translationData, ayahs: ayahsBangla } = useSurahTranslation(suraNumber, 'bn.bengali');
