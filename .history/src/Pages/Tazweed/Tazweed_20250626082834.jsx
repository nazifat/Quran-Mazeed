...
const Tazweed = () => {
    return (
        <div className='w-3/4 my-5 mx-auto tazweed-rules font-nunito leading-[2]'>
            <h1 className='text-3xl text-center p-5'>Tazweed Rules</h1>
            <img className='shadow-xl rounded-lg w-3/4 my-10' src="https://i.ibb.co/zWQrpgbc/learn-noorani-qaidah.webp" alt="" />
