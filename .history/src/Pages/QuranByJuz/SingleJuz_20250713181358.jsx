    ...
    return (
        ...
        <div className='grid grid-cols-1 text-right w-full md:w-3/4 mx-auto  md:px-5 px-1 py-10'>
            ...
            <div className='flex justify-center  gap-5 md:gap-10 items-center my-5'>
                <Link className='btn md:btn-md btn-xs previous-btn' onClick={handlePrevious} disabled={currentJuz === 1}>  Previous Juz</Link>
                <span className="font-medium text-gray-700 text-sm md:text-base">
                    Juz {currentJuz} of {totalJuz}
                </span>

                <Link className='btn md:btn-md btn-xs next-btn' onClick={handleNext} disabled={currentJuz === totalJuz}>Next Juz</Link>
            </div>
