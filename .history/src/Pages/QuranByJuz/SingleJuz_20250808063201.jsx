                    ...
                    ayahs?.map((ayah) => {
                        ...
                        return (
                            <div key={ayah.number} className=''>
                                ...
                                <div className="text-lg leading-relaxed text-gray-800 dark:text-gray-100 mb-4 md:py-5 py-0" dir="rtl" lang="ar" style={{ fontFamily: "'Scheherazade', serif" }}>
                                    {ayahs.map((ayah, index) => (
                                        <React.Fragment key={index}>
                                            <span className="inline font-taha text-2xl leading-[2]">
                                                {ayah.text}
                                            </span>
                                            <span className="mx-1 px-2 py-0.5 bg-[#AEE6F5] text-[#4F888B] rounded-full text-xs font-bold border border-[#4F888B] shadow-sm font-[Scheherazade] align-middle">
                                                {ayah.numberInSurah}
                                            </span>
                                        </React.Fragment>
                                    ))}
