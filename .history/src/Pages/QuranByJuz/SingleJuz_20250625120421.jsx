...

                {
                    ayahs?.map(ayah => (
                        ...
                        <div key={ayah.number} className=''>
                            ...
                            <p className="text-lg leading-relaxed text-gray-800 mb-4 md:py-5 py-0 border-b flex justify-between items-center">
                                <span className="font-hafs text-2xl text-right leading-[2]">{ayah.text}</span>
                                <span className="ml-4 px-3 py-1 bg-[#AEE6F5] text-[#4F888B] rounded-full text-sm font-bold border border-[#4F888B] shadow-sm font-[Scheherazade]">
                                    {ayah.numberInSurah}
                                </span>
                            </p>
