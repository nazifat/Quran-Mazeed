...

                {
                    ayahs?.map(ayah => (
                        ...
                        <div key={ayah.number} className=''>
                            <p className="flex items-center justify-end text-lg leading-relaxed text-gray-800 mb-4 md:py-5 py-0 border-b text-right">
                                <span className="font-hafs text-2xl leading-[2] ml-3">
                                    {ayah.text}
                                </span>
                                <span className="px-3 py-1 bg-[#AEE6F5] text-[#4F888B] rounded-full text-sm font-bold border border-[#4F888B] shadow-sm font-[Scheherazade]">
                                    {ayah.numberInSurah}
                                </span>
                            </p>
