                    ...
                    ayahs?.map((ayah) => {
                        ...
                        return (
                            <div key={ayah.number} className=''>
                                ...
                                <div className="text-lg leading-relaxed  inline text-gray-800 dark:text-gray-100 mb-4 md:py-5 py-0">
                                    <span  dir="rtl" lang="ar" className="inline font-taha text-2xl text-right leading-[2]">
                                        {ayahText}
