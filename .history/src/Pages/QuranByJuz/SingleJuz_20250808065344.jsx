                    ...
                    ayahs?.map((ayah) => {
                        ...
                        return (
                            <div key={ayah.number} className=''>
                                ...
                                <span className="text-lg inline flex flex-row-reverse text-gray-800 dark:text-gray-100 ">
                                    <span className="font-taha text-2xl text-right leading-[2]">
                                        {ayahText}


                                        {ayahText && <span className="inline-block mx-2 mt-2 px-3 py-1 bg-[#AEE6F5] text-[#4F888B] rounded-[100%] text-sm font-bold  border border-[#4F888B] shadow-sm font-[Scheherazade]">
                                            {ayah.numberInSurah}
                                        </span>}
