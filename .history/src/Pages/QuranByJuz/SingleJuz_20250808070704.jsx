            ...
            <div className="my-6">
...

                {
                    ayahs?.map((ayah) => {
                        ...
                        return (
                            <div key={ayah.number} className="inline text-left my-5 py-10" dir='rtl'>
                                ...
                                {showSurahName && surahs[currentSurahNum] && (
                                    <div>
                                        <h2
                                            ...
                                            dir="ltr" // Surah heading is LTR or center aligned (optional)
                                        >
                                        ...
                                        {currentSurahNum !== 9 && (
                                            <p
                                                ...
                                                dir="ltr" // Basmala is LTR or center aligned
                                            >
                                                ﷽
                                            </p>
                                        )}
