                    ...
                    ayahs?.map((ayah) => {
                        ...
                        return (
                            <div key={ayah.number} className=''>
                                ...
                                {/* This div wraps all ayahs inline */}
                                <div dir="rtl" lang="ar" className="text-lg text-gray-800 dark:text-gray-100 leading-relaxed mb-4 md:py-5 py-0">
                                    {/* Single ayah inline block */}
                                    <span key={ayah.number} className="inline-block mr-4">
                                        <span className="font-taha text-2xl leading-[2] inline">
                                            {ayah.text}
                                        </span>
