                    ...
                    ayahs?.map(ayah => (
                        ...
                        <div key={ayah.number} className=''>
                            ...
                            <p className="text-lg leading-relaxed text-gray-800 mb-4 md:py-5 py-0 border-b text-right font-hafs text-2xl leading-[2]">
                                {ayah.text}
                                <span className=" text-left inline-block mx-2 px-3 py-1 bg-[#AEE6F5] text-[#4F888B] rounded-full text-sm font-bold border border-[#4F888B] shadow-sm font-[Scheherazade] align-middle">
                                    {ayah.numberInSurah}
                                </span>
                            </p>
