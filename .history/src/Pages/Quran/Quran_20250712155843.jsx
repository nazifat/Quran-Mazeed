    ...
    return (
        <div className='md:w-3/4 w-full mx-auto md:p-10 p-0 m-2 custom-quran ' >
            ...
            >
                ...
                <div className="tab-content dark:bg-base-100 bg-gray-200 dark:border-base-300 p-6">

                    <div className='grid md:grid-cols-4 grid-cols-1 gap-5 text-center bg-white dark:bg-black'>
