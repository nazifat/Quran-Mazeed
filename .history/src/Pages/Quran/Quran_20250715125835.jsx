    ...
    return (
        <div className='md:w-3/4 w-full mx-auto md:p-10 p-0 m-2 custom-quran ' >
            ...
            >
                ...
                <input type="radio" name="my_tabs_3" className="tab custom-tab " aria-label="Juz" />400
                <div className="tab-content dark:bg-black bg-gray-100 border-base-300 p-6 dark:text-red-100">
