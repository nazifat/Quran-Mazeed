...

                        {
                            surahs.map(surah => (
                                <Link
                                    ...
                                    className="block dark:bg-black dark:text-white bg-white shadow-md rounded-xl p-5 hover:shadow-xl hover:border-[#2fd6d9] transition duration-300 border border-gray-200"
                                >
