        ...
        <div className='md:w-3/4 w-full mx-auto md:p-10 p-0 m-2 custom-quran ' >
            ...
            >
                ...
                <div className="tab-content dark:bg-gray-600 bg-gray-200 dark:border-gray-500 p-6">
                    ...
                    <div className='grid md:grid-cols-4 grid-cols-1 gap-5 text-center bg-white dark:bg-gray-600'>
...

                        {
                            surahs.map(surah => (
                                <Link
                                    ...
                                    className="block dark:bg-black dark:text-gray-100 bg-white shadow-md rounded-xl p-5 hover:shadow-xl hover:border-[#2fd6d9] transition duration-300 border border-gray-200"
                                >
