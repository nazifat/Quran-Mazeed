    ...
    return (
        <div className='md:w-3/4 w-full mx-auto md:p-10 p-0 m-2 custom-quran ' >
            ...
            >
                ...
                <div className="tab-content dark:bg-gray-600 bg-gray-200 dark:border-gray-100 p-6">
                ...
                <div className="tab-content dark:bg-gray-600 bg-gray-100 border-base-300 p-6 dark:text-red-100">
                    <QuranByJuz></QuranByJuz>
                </div>
                <input type="radio" name="my_tabs_3" className="tab custom-tab" aria-label="Page" />
                <div className="tab-content dark:bg-gray-600 bg-gray-100 border-base-300 p-6">
