        ...
        >
            ...
            >
                ...
                <div className="tab-content bg-base-100 border-base-300 p-6">
                    ...
                    <div className='grid grid-cols-4 gap-5 text-center'    style={{
                    ...
                    backgroundAttachment: "fixed"
                        ...
                        {
                            surahs.map(surah => (
                                <Link key={surah.number} className=' bg-gray-100  max-w-sm rounded-lg border border-gray-500 px-2 py-5'>
                                    <p>{surah.name}</p>
