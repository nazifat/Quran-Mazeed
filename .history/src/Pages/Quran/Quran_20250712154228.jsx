...
const Quran = () => {
    ...
    return (
        <div className='md:w-3/4 w-full mx-auto md:p-10 p-0 m-2 ' >
            {/* name of each tab group should be unique */}
            <div className="tabs tabs-lift"

            >
                <input type="radio" name="my_tabs_3" className="tab" aria-label="Surah" defaultChecked />
                <div className="tab-content dark:bg-base-100 bg-red-100 dark:border-base-300 p-6">
                ...
                <input type="radio" name="my_tabs_3" className="tab" aria-label="Page" />
                <div className="tab-content bg-base-100 border-base-300 p-6">
