...
const Contact = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 p-6"   style={{
      backgroundImage: "url('https://i.ibb.co/XrFGCv9y/360-F-390013158-Ns-ITKTs0w-Egws8-ICtk-TJIl-Jke-Vlt-Kw-GY.jpg')"
    }}
  >
