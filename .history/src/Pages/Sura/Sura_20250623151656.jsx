...
const Sura = () => {
    ...
    return (
        <div className=' p-10'>
            <h1 className="text-xl md:text-2xl md:w-1/4 w-full mx-auto font-bold text-center text-gray-700 mb-6 tracking-wide font-nunito border px-5 py-2 rounded-lg bg-[#C8EFF9] hover:bg-[#AEE6F5] transition-colors duration-300">
...

            {
                suraNumber !== '1' && suraNumber !== '9' &&  page===1 &&(
                    <p className="text-center text-4xl font-hafs my-4 text-[#2FD6D9] md:py-5 border-y py-2">
                        ﷽
                    </p>
                )
            }
