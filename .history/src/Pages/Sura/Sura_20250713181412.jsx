    ...
    return (
        <div className=' p-10'>
            ...
            <div className='flex justify-center  gap-5 md:gap-10 items-center'>
                <Link className='btn md:btn-md btn-xs previous-btn' onClick={handlePrevious} disabled={page === 1}>  Previous page</Link>
                <span className="font-medium text-gray-700 text-sm md:text-base">
                    Page {page} of {totalPages}
                </span>

                <Link className='btn md:btn-md btn-xs next-btn' onClick={handleNext} disabled={page === totalPages}>Next Page</Link>
            </div>
