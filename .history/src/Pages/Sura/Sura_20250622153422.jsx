                ...
                <div className='' key={ayah.numberInSurah}>
                    <p className="text-lg leading-relaxed text-gray-800 mb-4 py-5">
                        <span className="block font-notoArabic text-2xl text-right">
                            ...
                            <span className="mx-2 mt-2 flex items-center justify-center bg-[#DAF5F0] text-[#4F888B] rounded-full text-sm font-bold w-8 h-8 border border-[#4F888B] shadow-sm font-[Scheherazade]">
                                {ayah.numberInSurah}
                            </span>
