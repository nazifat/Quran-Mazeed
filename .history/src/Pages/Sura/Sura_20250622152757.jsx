                ...
                <div className='' key={ayah.numberInSurah}>
                    <p className="text-lg leading-relaxed text-gray-800 mb-4 py-5">
                        <span className="block font-notoArabic text-2xl text-right">
                            ...
                            <span className="mx-2 mt-2 px-3 py-1 bg-[#DAF5F0] text-[#DAF5F0] rounded-full text-sm font-bold tracking-wide border border-emerald-300 shadow-sm font-[Scheherazade]">
                                 {ayah.numberInSurah}
                            </span>
