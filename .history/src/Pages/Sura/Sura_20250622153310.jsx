                ...
                <div className='' key={ayah.numberInSurah}>
                    <p className="text-lg leading-relaxed text-gray-800 mb-4 py-5">
                        <span className="block font-notoArabic text-2xl text-right">
                            ...
                            <span className="h-[10px] w-[10px] mx-2 mt-2 px-3 py-1 bg-[#DAF5F0] text-[#4F888B] rounded-[100%] text-sm font-bold tracking-wide border border-[#4F888B] shadow-sm font-[Scheherazade]">
                                 {ayah.numberInSurah}
                            </span>
