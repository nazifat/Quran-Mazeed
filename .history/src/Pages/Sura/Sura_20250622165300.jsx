...
const Sura = () => {
    ...
    return (
        <div className=' p-10'>
            <h1 className="text-xl md:text-2xl md:w-1/4 w-full mx-auto font-bold text-center text-gray-700 mb-6 tracking-wide font-inter border px-5 py-2 rounded-lg bg-[#DAF5F0] hover:bg-[#C3EBE2] transition-colors duration-300">
                <span className='font-notoArabic text-base block my-2'> {suraData?.name}</span>
            ...
            <div className='flex justify-between md:mx-20 mx-2'>
                <Link className='btn btn-lg'>Previous page</Link>
                <Link className='btn btn-lg'>Next Page</Link>
            </div>
