        ...
        <div className=' p-10'>
...

            {
                suraNumber !== '1' && suraNumber !== '9' && (
                    <p className="text-center text-xl font-notoArabic my-4 text-[#2FD6D9] py-10">
                        ﷽
                    </p>
                )
            }
            ...
            <div className='flex justify-center  gap-5 md:gap-10nitems-center'>
                <Link className='btn md:btn-lg btn-xs' onClick={handlePrevious} disabled={page === 1}>  Previous page</Link>
                <span className="font-medium text-gray-700 text-sm md:text-base">
                    Page {page} of {totalPages}
                </span>

                <Link className='btn md:btn-lg btn-xs' onClick={handleNext} disabled={page === totalPages}>Next Page</Link>
            </div>
