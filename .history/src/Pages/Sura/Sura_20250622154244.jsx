...
const Sura = () => {
    ...
    return (
        <div className=' p-10'>
            <h1 className="text-2xl md:text-3xl w-1/4 mx-auto font-bold text-center text-gray-700 mb-6 tracking-wide font-inter border p-5 rounded-full bg-[#DAF5F0] hover:bg-[#C3EBE2] transition-colors duration-300">
