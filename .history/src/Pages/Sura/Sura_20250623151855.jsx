...
const Sura = () => {
    ...
    return (
        <div className=' p-10'>
            <h1 className="text-xl md:text-2xl md:w-1/4 w-full mx-auto font-bold text-center text-gray-700 tracking-wide font-nunito border px-5 py-2 rounded-full bg-[#C8EFF9] hover:bg-[#AEE6F5] transition-colors duration-300">
