            ...
            <div className="hero min-h-screen bg-[#ECFBF9] relative" >
                <div className="hero-content flex-col lg:flex-row-reverse md: gap-20">
                    ...
                    <div className='space-y-3 text-center md:text-left'>
                        ...
                        <h1 className="text-3xl md:text-4xl animate-slide-in-top font-bold text-[#2C366E] md:leading-[1.5]">  And We have certainly made the Quran easy to remember.
                         So is there anyone who will be mindful? (54:40)</h1>
