...
const Banner = () => {
    return (
        <div className='relative' >
            <div className="hero min-h-screen bg-[#ECFBF9]  dark:bg-[#2C3E50] relative" >
                    ...
                    <div className='space-y-4 text-center md:text-left max-w-xs lg:max-w-full'>
                        <div className='relative  overflow-hidden'>
                            <div className='animate-slide-in-left'>
                                <span className='my-10 bg-[#fff] text-[#42CDD0] border border-0 rounded-full px-4 py-6 text-sm font-bold animate-slide-in-left' >
                                    Know Your Deen</span>
                            </div>
                        </div>
