    ...
    return (
        <div className='relative'>
            <div className="hero min-h-screen bg-[#ECFBF9] relative " >
                <div className="hero-content flex-col lg:flex-row-reverse md:gap-20 w-full max-w-7xl">
                    <img
                        src={quranBanner}
                        className="animate-slide-in-right max-w-sm"
                    />
                    <div className='space-y-4 text-center md:text-left max-w-xs lg:max-w-full'>
                        ...
                        <p className="py-6 font-light animate-typing
                         whitespace-nowrap text-sm sm:text-base overflow-hidden border-r-0">
