            ...
            <div className="hero bg-base-200 min-h-screen bg-[#ECFBF9]" >
                <div className="hero-content flex-col lg:flex-row-reverse gap-10">
                    ...
                    <div className='space-y-4'>
                        <span className='my-10 bg-[#fff] text-[#42CDD0] border border-0 rounded-full px-4 py-2 text-sm font-semibold' >Know Your Deen</span>
                        <h1 className="text-5xl font-medium text-[#2C366E] leading-[1.25]">  Read! In the name of your lord, <br/> Who has created you</h1>
