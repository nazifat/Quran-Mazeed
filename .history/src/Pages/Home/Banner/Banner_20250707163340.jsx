                    ...
                    <div className='space-y-4 text-center md:text-left max-w-xs lg:max-w-full'>
                        <div className='relative  overflow-hidden'>
                            <div className='animate-slide-in-left'>
                                <span className='my-10 dark:bg-[#00B4D8] dark:text-gray-100 bg-[#fff] text-[#42CDD0] border border-0 rounded-full px-4 py-6 text-sm font-bold animate-slide-in-left' >
                                    Know Your Deen</span>
                            </div>
                        </div>
