            ...
            <div className="hero min-h-screen bg-[#ECFBF9] relative" >
                <div className="hero-content flex-col lg:flex-row-reverse md: gap-20">
                    ...
                    <div className='space-y-3 text-center md:text-left'>
                        ...
                        <h1 className="text-3xl md:text-5xl animate-fadeIn font-bold text-[#2C366E] md:leading-[1.5]">  Read! In the name of your lord, Who has created </h1>
                        <p className="py-6 font-light slideInLeft
                        overflow-hidden whitespace-nowrap border-r-4 border-red">
                            Read Quran and Quran Blog Online!
                            The best platform to read Quran.
                        </p>
                        <CustomBtn2 className="btn btn-primary slideInLeft">Get Started</CustomBtn2>
                    </div>
                </div>
