        ...
        <section className="bg-white py-16 px-4 md:px-10 lg:px-20">
            <div className="max-w-6xl  w-full mx-auto flex flex-col md:flex-row items-center justify-center-safe ">
                ...
                <div className=" text-center md:text-left md:w-1/2 w-full">
                    ...
                    <h2 className={`hidden-slide text-sm md:text-xl font-bold text-[#10D0D5] mb-4 animate-slide-in-right h-auto ${isVisible ? 'animate-slide-in-left' : ''}`}
                    ...
                    <p className="text-gray-500 text-base leading-relaxed animate-slide-in-right leading-[2]">
