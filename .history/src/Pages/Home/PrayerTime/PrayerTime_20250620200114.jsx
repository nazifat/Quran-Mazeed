...
const PrayerTime = () => {
    ...
    return (
        <div className="flex flex-col md:flex-row items-center gap-2  justify-between w-3/4 mx-auto">
            ...
            <div className='text-center bg-white px-6 rounded shadow-md max-w-sm mx-auto md:w-1/2 w-full '>
