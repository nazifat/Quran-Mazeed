    ...
    useEffect(() => {
        ...
        fetch('http://ipwho.is/')
            ...
            .then((data) => {
                ...
                setDate(data.data.date.gregorian.date.weekday.en);
            })
            .catch(err => {
                console.error(err);
    ...
    return (
        <div className="flex flex-col md:flex-row items-center gap-2  justify-center w-full  min-h-screen mx-auto prayer-time p-5 md:p-20">
            <div className='w-full  md:w-1/2 '>
                ...
                <h3 className="text-2xl md:text-4xl font-bold mb-4  text-[#2C366D] ">Prayer Times of {location}</h3>
            ...
            <div className='text-center bg-white  rounded-lg shadow-md max-w-sm  md:w-1/2 w-full mx-10 '>
                ...
                <div className="overflow-x-auto">
                    <table className="table ">
                        ...
                        <thead className='bg-[#D4F6F5] text-[#2C366D] text-xl '>
                            <tr>
                                <th>Prayer Name</th>
                                <th> Time</th>
                            </tr>
